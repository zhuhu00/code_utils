/*
 * @Description: Blur,高斯滤波,椒盐滤波的均值滤波
 * @Version: 
 * @Author: Huge
 * @Date: 2021-09-15 12:10:25
 */
...
{
    Mat equalLena = imread("../../data/equalLena.png", IMREAD_ANYDEPTH);
    Mat equalLena_gauss = imread("../../data/equalLena_gauss.png", IMREAD_ANYDEPTH);
    Mat equalLena_salt = imread("../../data/equalLena_salt.png", IMREAD_ANYDEPTH);
